                    ...
                    <div class="box">
                        <div class="box-header">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li>
                                    <a href="<?= $base_url . 'mahasiswa' ?>">Tabel Mahasiswa</a>
                                </li>
                        ...
                        <?php 
                            ...
                            $sql = "SELECT mahasiswa.id,  mahasiswa.username, mahasiswa.nama_lengkap, mahasiswa.email, mahasiswa.dob, mahasiswa.phone, mahasiswa.nim FROM mahasiswa WHERE mahasiswa.id ='$get_id';";
							...
							if($_SERVER["REQUEST_METHOD"] == "POST"){
								...
								if($nim !== $ambil['nim']){
									$prm = mysqli_real_escape_string($db, $nim);
									$query.= "nim = '$prm', ";
								...
								$query.= "WHERE mahasiswa.id = '$get_id';";
								
								if (strpos($query, ', WHERE ') !== false) {
									$query = str_replace(', WHERE ', ' WHERE ', $query);
								}else{
									header('Location: ../mahasiswa'); //tamper ato error ato ngapain lah.
									exit;
								}
									...
									<div class='form-group'>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-6">
                                                <input type="submit" class="btn btn-success btn-block margin-bottom" value="Update Data ">
                                            </div>
                                        </div>
