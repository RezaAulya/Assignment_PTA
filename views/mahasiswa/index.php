                                    ...
                                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-sm-2">Foto Mahasiswa</th>
                                        ...
                                        <tbody>
                                            <?php
                                                        ...
                                                        // QUERY Here !!
                                                        $sql = "SELECT mahasiswa.id, mahasiswa.username, mahasiswa.nama_lengkap, mahasiswa.email FROM mahasiswa;";
                                                        ...
                                                        while ($row = mysqli_fetch_array($result)){
                                                            ...
                                                            echo 
                                                                ...
                                                                <td>
                                                                <a href='mahasiswa-view/" . $row["id"] . " ' class='btn btn-success btn-xs mrg' data-placement='top' 
                                                                data-toggle='tooltip' data-original-title='View'><i class='fa fa-check-square-o'></i>
                                                                </a>

                                                                <a href='mahasiswa-edit/" . $row["id"] . " ' class='btn btn-warning btn-xs mrg' data-placement='top' 
                                                                data-toggle='tooltip' data-original-title='Edit'><i class='fa fa-edit'></i>
                                                                </a>

                                                                <a href='#' onclick='if(confirm(\"Apakah anda yakin akan menghapus dosen yang dipilih?\")){window.location.href = \"mahasiswa-delete/" . $row["id"] . "\";}' class='btn btn-danger btn-xs mrg' data-placement='top' 
